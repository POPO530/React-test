...
export const createMazeWalls = (scene) => {
  ...
  // 壁のデータ（位置とサイズ）
  const wallData = [
    { w: 10, h: 1, d: 0, pos: [-3, 4, 0] },  // 上部左の水平壁
    { w: 10, h: 1, d: 0, pos: [3, 4, 0] },   // 上部右の水平壁
    { w: 1, h: 10, d: 0, pos: [-7, 0, 0] },  // 左上の垂直壁
    { w: 1, h: 10, d: 0, pos: [7, 0, 0] },   // 右上の垂直壁
    { w: 10, h: 1, d: 0, pos: [-3, -4, 0] }, // 左下の垂直壁
    { w: 10, h: 1, d: 0, pos: [3, -4, 0] },  // 右下の垂直壁
  ];
